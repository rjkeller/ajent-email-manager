<?php
	...
	global $sBNCode, $API_Endpoint, $PAYPAL_URL;
	...
	*/
	function hash_call($methodName,$nvpStr)
	{
	   ...
	   //Set proxy name to PROXY_HOST and port number to PROXY_PORT in constants.php 
		...
		$nvpreq="METHOD=" . urlencode($methodName) . "&VERSION=" . urlencode($version) . "&PWD=" . urlencode($API_Password) . "&USER=" . urlencode($API_UserName) . "&SIGNATURE=" . urlencode($API_Signature) . $nvpStr . "&BUTTONSOURCE=" . urlencode("PP-ECWizard");
